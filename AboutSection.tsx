...
const AboutSection: React.FC<AboutProps> = ({ data }) => {
  ...
  const qualities = [
    ...
    },
    {
      ...
      description: "Pursuing a Bachelor's degree in Computer Science with a focus on full-stack web development and modern technologies."
    }
  ];
            ...
            <div className="relative">
              ...
              <div className="relative bg-surface-light dark:bg-surface-dark p-6 rounded-lg shadow-xl">
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  Currently focused on enhancing my web development skills and exploring new technologies to improve user experience and system performance.</p>
                </div>
              </div>
            </div>
          </motion.div>
